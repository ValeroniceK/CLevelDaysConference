...
window.CV_CONTENT = {
  ...
  /* ---- 00 // MISSION (хук — первое, что читают, должно цеплять) --------- */
  missionHeadline: "Готов усилить вас, вашу команду и вашу компанию.",
  missionText: "Выстраиваю автоматизацию тестирования с нуля. Настраивал процессы и в командах на сотни человек, и там, где был единственным QA — знаю, что сработает у вас, независимо от размера команды.",
