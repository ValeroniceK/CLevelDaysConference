...
window.CV_CONTENT = {
  ...
  missionHeadline: "Готов усилить вас и вашу компанию.",
  missionLead: "Если хотя бы один ответ — «да», буду рад вам помочь:",
  // Каждый пункт — диагностический вопрос-хук
  missionQuestions: [
    "Вы создаёте продукт, но тестирование съедает слишком много времени?",
    "Активно внедряете AI и ускоряете разработку, но не уверены, что на проде всё будет гладко?",
    "Хотите вывести продукт на новый уровень?",
