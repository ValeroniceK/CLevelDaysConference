...
window.CV_CONTENT = {
  ...
  /* ---- 01 // ABOUT ------------------------------------------------------- */
  about: "QA Automation Engineer с 8+ годами опыта в обеспечении качества — от единственного тестировщика в стартапе до performance-инженера в студии на 300+ человек. Превращаю качество в конкурентное преимущество: ускоряю релизы, автоматизирую рутину и снижаю число багов, которые долетают до пользователей. AI использую не потому что модно, а чтобы автоматизировать рутину и экономить команде дни ручной работы каждый спринт.",
  ...
  highlights: [
    ...
    { stat: "1–5 дн.",  tag: "ONE-CLICK REPORTING",   text: "Автоматические репорты/отчеты в Slack/Jira и тд. по нажатию одной кнопки. Информативные графики которые дают понимание о текущем состоянии продукта." },
    { stat: "AI",       tag: "REAL AI, NOT A DEMO",   text: "Внедрил AI подходы в рабочие процессы и обучил модель искать проблемы в контенте." },
    { stat: "4",        tag: "CROSS-INDUSTRY",        text: "Медицинские, образовательные и инженерные продукты — и стартап, который прошёл путь от первой строчки документации до награды «Best Startup 2019» (Грузия)." },
  ],
  ...
  /* ---- CTA (финальный блок) --------------------------------------------- */
  ctaText: "Ускоряю релизы, снижаю баги в проде и экономлю бюджет на ручном QA — без раздувания команды",
};
