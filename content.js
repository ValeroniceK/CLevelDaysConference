...
window.CV_CONTENT = {
  ...
  highlights: [
    ...
    { stat: "98%",      tag: "NEAR-ZERO PROD BUGS",   text: "Покрытие автотестами регрессии выросло с 20% до 98%. Каждый новый релиз это четкий и последовательный процесс." },
    { stat: "1–5 дн.",  tag: "MANUAL WORK SAVED",     text: "Автоматические репорты/отчеты в Slack/Jira и тд. по нажатию одной кнопки. Информативные графики которые дают понимание о текущем состоянии продукта." },
